...
### 平台参数建议
- **Midjourney**: `--ar 16:9 --style raw --s 50`
- **可灵**: 浅暖灰背景建议加 `--no gradient background`
...
- **可灵**: 上传此图作为Actor ID参考，Canvas锁脸首选
